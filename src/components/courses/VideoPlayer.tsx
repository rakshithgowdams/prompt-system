          ...
          >
            ...
            >
              <motion.div
                ...
                style={{ background: 'rgba(0,0,0,0.45)', backdropFilter: 'blur(6px)', border: '1.5px solid rgba(255,255,255,0.18)' }}
              >
                <Icon name="replay_10" size={32} className="text-white" />
              </motion.div>
              <span className="text-white/80 text-[11px] font-semibold tracking-wide drop-shadow">10s</span>
            </button>
            ...
            <button
              ...
              style={{ WebkitTapHighlightColor: 'transparent', touchAction: 'manipulation' }}
              onPointerDown={(e) => { e.stopPropagation(); e.currentTarget.setPointerCapture(e.pointerId); }}
              onPointerUp={(e) => { e.stopPropagation(); togglePlay(); showControls(); }}
            ...
            >
              <motion.div
                ...
                style={{ background: 'rgba(0,0,0,0.45)', backdropFilter: 'blur(6px)', border: '1.5px solid rgba(255,255,255,0.18)' }}
              >
                <Icon name="forward_10" size={32} className="text-white" />
              </motion.div>
              <span className="text-white/80 text-[11px] font-semibold tracking-wide drop-shadow">10s</span>
            </button>
          </motion.div>
