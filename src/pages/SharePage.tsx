        ...
        <motion.div initial={{ opacity: 0, y: 16, scale: 0.97 }} animate={{ opacity: 1, y: 0, scale: 1 }} className="w-full max-w-sm">
          ...
          <div className="mt-4 p-4 bg-gray-900/60 border border-gray-800 rounded-2xl flex items-center justify-between gap-3">
            <div className="min-w-0">
              <p className="text-xs font-semibold text-white">New to aiwithrakshith.tech?</p>
    ...
    <div className="min-h-screen bg-gray-950 pb-28">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-8 py-8 space-y-8">
        ...
        <section className="mt-6">
          <div className="bg-gradient-to-r from-gray-900 via-gray-900 to-gray-900 border border-gray-800 rounded-2xl overflow-hidden">
            ...
            <div className="px-4 py-4 sm:px-6 flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-500 mt-0.5">Follow for AI tutorials, tools &amp; free resources</p>
              </div>
              <div className="flex items-center gap-2 flex-shrink-0">
                <a href="https://www.instagram.com/aiwithrakshith?igsh=anAxYmJrdWhsODFj" target="_blank" rel="noopener noreferrer"
